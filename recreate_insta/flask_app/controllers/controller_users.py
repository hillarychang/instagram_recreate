...
def showUser():
    ...
    # print("POST OBJECT",comment_with_post.comment)
    # for i in comment_with_post.comment:
    #     print("WHATISTHIS",i)
    #     print("OKTHISSHOULDWORK",i['comment'])
    #     print("Commented",i['first_name'])

        # ^do i need comment_with_post in the html??

    return render_template("result.html", comment_post = comment_with_post, all_posts = posts, users = user) 
